...
interface BookAuthorRoleSelectorProps {
...
export function BookAuthorRoleSelector({
  ...
  return (
    <div className="relative inline-block" ref={containerRef}>
      ...
      {dropdownOpen && (
        <ul className="z-20 absolute overflow-auto rounded-lg bg-muted border-accent border-2 border-b-4 right-0 font-[Helvetica] font-medium">

...
{
    public static async Task<List<BookAuthor>> AssembleBookAuthors(Book book, List<AuthorWithRoleDTO> authorsWithRoles, IBaseRepository<Author> authorRepository)
